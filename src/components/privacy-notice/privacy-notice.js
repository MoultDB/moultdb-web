...
export default function PrivacyNotice() {
    ...
    useEffect(() => {
        document.title = "MoultDB - Privacy notice"
    }, []);
    ...
    return (
        <main className={'row'}>
            <div className={'col-sm-10 offset-sm-1'}>
                ...
                <p>We do not use Matomo to track you individually or collect personal data. Personal data send to Matomo
                    are anonymized upstream.</p>
