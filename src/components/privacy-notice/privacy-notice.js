            ...
            <div className={'row'}>
                <div className={'col-sm-10 offset-sm-1'}>
                    ...
                    <p>The University of Lausanne complies with these requirements in its capacity as a processor.
                        As data controller when using MoultDB, the Department of Ecology and Evolution of the Faculty of Biology and Medicine of UNIL respects these prerogatives.</p>
                    ...
                    <p>This policy concerns the processing of your data collected as a user of the website https://moultdb.org/.</p>
                    <p>This policy is dated September, 2021. However, it is likely to be updated on a regular basis; if so, you will be informed via the website https://moultdb.org/. Any use of our services after this notification has been published will be deemed acceptance of the latest version of this policy.</p>
                    ...
                    <p>Data analyzes are carried out to find out the characteristics of MoultDB users. These are however carried out on fully anonymized data.</p>
                    ...
                    <p>MoultDB may also be required to disclose your data in order to fulfil its statutory obligations, in response to a request from a judicial or administrative authority or in accordance with its statutory obligations or in relation to legal proceedings.</p>
                    ...
                    <p>MoultDB uses Matomo as a third-party analytics service to collect information about website performance and how users navigate through and use our site to help us design better interfaces. The list below provides a summary of the type of data Matomo collects:</p>
                    <ul>
                    ...
                    <h2>Contact</h2>
                    <p>You can contact the MoultDB team with any questions you may have about this policy by sending an&nbsp;
                        <Obfuscate email= {process.env.REACT_APP_CONTACT_EMAIL}
