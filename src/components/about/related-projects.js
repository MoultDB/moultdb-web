    ...
    return (
        <div className="row">
            <div className='col-sm-10 offset-sm-1'>
                ...
                <p>This page provides current collaborations of the MoultDB project (in alphabetical order).</p>
                <dl>
                    <dt><h2>Bgee - gene expression data in animals</h2></dt>
                    <dd>
                    ...
                    <dt><h2>ERGA - European Reference Genome Atlas</h2></dt>
                    <dd>
                    ...
                    <dt><h2>Selectome - positive selection database</h2></dt>
                    <dd>
                        <p><a href="https://selectome.org" title="Selectome" rel="noopener noreferrer" target="_blank">Selectome</a> is a database of positive selection based on rigorous alignment filtering method and branch-site specific likelihood test. Positive selection is detected using <a href="http://abacus.gene.ucl.ac.uk/software/paml.html" rel="noopener noreferrer" target="_blank">CODEML</a> on all branches of animal gene trees.</p>
